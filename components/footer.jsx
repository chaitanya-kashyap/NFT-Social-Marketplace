        ...
        <div class="px-5 py-12 mx-auto max-w-7xl lg:py-16 md:px-12 lg:px-20">
            ...
            <div class="grid grid-cols-2 gap-8 mt-12 xl:mt-0 xl:col-span-2">
                ...
                <div>
                    ...
                    <li>
                        <a href="#" class="text-sm font-normal text-gray-500 hover:text-gray-900"> Art </a>
                    </li>

                    <li>
                        <a href="#" class="text-sm font-normal text-gray-500 hover:text-gray-900"> Collectibles </a>
                    </li>

                    <li>
                        <a href="#" class="text-sm font-normal text-gray-500 hover:text-gray-900"> Music </a>
                    </li>
                    <li>
                        <a href="#" class="text-sm font-normal text-gray-500 hover:text-gray-900"> Photography </a>
                    </li>
                    </ul>
                </div>
                <div class="mt-12 md:mt-0">
                    ...
                    <ul role="list" class="mt-4 space-y-4">
                    <li>
                        <a href="#" class="text-sm font-normal text-gray-500 hover:text-gray-900"> Help Center </a>
                    </li>
