    ...
    return (
        ...
        <div class="px-5 py-12 mx-auto max-w-7xl lg:py-16 md:px-12 lg:px-20">
            ...
            <div class="grid grid-cols-2 gap-8 mt-12 xl:mt-0 xl:col-span-2">
                ...
                <div>
                    <h3 class="text-xs font-semibold tracking-wider text-purple-600 uppercase">Marketplace</h3>
                    <ul role="list" class="mt-4 space-y-4">
                    <li>
                        <a href="#" class="text-sm font-normal text-gray-500 hover:underline"> Art </a>
                    </li>

                    <li>
                        <a href="#" class="text-sm font-normal text-gray-500 hover:underline"> Collectibles </a>
                    </li>

                    <li>
                        <a href="#" class="text-sm font-normal text-gray-500 hover:underline"> Music </a>
                    </li>
                    <li>
                        <a href="#" class="text-sm font-normal text-gray-500 hover:underline"> Photography </a>
                    </li>
                    </ul>
                </div>
                <div class="mt-12 md:mt-0">
                    <h3 class="text-xs font-semibold tracking-wider text-purple-600 uppercase">Resources</h3>
                    <ul role="list" class="mt-4 space-y-4">
                    <li>
                        <a href="#" class="text-sm font-normal text-gray-500 hover:underline"> Help Center </a>
                    </li>

                    <li>
                        <a href="#" class="text-sm font-normal text-gray-500 hover:underline"> Pricing </a>
                    </li>

                    <li>
                        <a href="#" class="text-sm font-normal text-gray-500 hover:underline"> Guides </a>
                    </li>

                    <li>
                        <a href="#" class="text-sm font-normal text-gray-500 hover:underline"> API Status </a>
                    </li>
                    </ul>
                </div>
                </div>
        ...
        <div class="px-5 py-6 mx-auto bg-black max-w-7xl sm:px-6 md:flex md:items-center md:justify-between lg:px-20">
            ...
            <span className="text-gray-500 text-sm font-light text-center pl-72 " >
