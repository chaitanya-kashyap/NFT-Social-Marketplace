...
export default function Footer() {
  ...
  return (
    <footer
      class="bg-black mx-32 px-2.5 divide-y divide-gray-800"
      ...
      <div class="px-5 py-12 mx-auto max-w-7xl lg:py-16 md:px-12 lg:px-20">
        <div class="xl:grid xl:grid-cols-3 xl:gap-8">
          <div class="space-y-8 xl:col-span-1">
            <p class="text-lg font-medium tracking-tighter text-purple-600 transition duration-500 ease-in-out transform tracking-relaxed lg:pr-8">
              {" "}
              Black Pearl{" "}
            </p>
            <p class="w-1/2 mt-2 text-sm text-gray-500">
              Marketplace for NFT's{" "}
            </p>
          </div>
          <div class="grid grid-cols-2 gap-8 mt-12 xl:mt-0 xl:col-span-2">
            <div class="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 class="text-xs font-semibold tracking-wider text-purple-600 uppercase">
                  Marketplace
                </h3>
                  ...
                  <div class="inline-flex items-center gap-2 mt-4 list-none lg:ml-auto">
                    <div class="p-1 mt-4 transition duration-500 ease-in-out transform border2 bg-gray-50 rounded-xl sm:max-w-lg sm:flex">
                      <div class="flex-1 min-w-0">
                        ...
                        <input
                          class="block w-full px-3 py-1 text-lg text-neutral-600 placeholder-gray-300 transition duration-500 ease-in-out transform bg-transparent border border-transparent rounded-md focus:outline-none focus:border-transparent focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-300"
                      ...
                      <div class="mt-4 sm:mt-0 sm:ml-3">
                        <button
                          onClick={openModal}
                          class="block py-2 text-sm font-medium text-white bg-purple-600 border border-transparent rounded-lg hover:bg-purple-700 shadow-lg sm:px-6"
                        >
                          Notify me
                        </button>
                      </div>
                              ...
                              <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                                ...
                                <div className="mt-2">
                                  <p className="text-sm text-gray-500">
                                    ...
                                    newsletter. Enjoy our latest content.
                                  </p>
                                </div>
