...
import G from '../../assets/lol.png'
import C from '../../assets/thor.jpeg'
            ...
            <section class="ml-80">
                <div class="flex flex-wrap mx-auto md:flex-nowrap p-12">
                    ...
                    <div class="flex w-full">
                        ...
                        <Image class="object-cover object-center w-full rounded-t-xl lg:h-48 md:h-36" src={S} alt="blog" />
                        <div class="px-6 py-8">
                    ...
                    <div class="flex w-full">
                        <div class="relative flex flex-col items-start m-1 transition duration-300 ease-in-out delay-150 transform bg-white shadow-2xl rounded-xl md:w-80 md:-ml-16 md:hover:-translate-x-16 md:hover:-translate-y-8">
                        <Image class="object-cover object-center w-full rounded-t-xl lg:h-48 md:h-36" src={G} alt="blog" />
                        <div class="px-6 py-8">
                            <h4 class="mt-4 text-2xl font-semibold text-neutral-600">
                            <span class="">Entry</span>
                            </h4>
                    ...
                    <div class="flex w-full">
                        <div class="relative flex flex-col items-start m-1 transition duration-300 ease-in-out delay-150 transform bg-white shadow-2xl rounded-xl md:w-80 md:-ml-16 md:hover:-translate-x-16 md:hover:-translate-y-8">
                        <Image class="object-cover object-center w-full rounded-t-xl lg:h-48 md:h-36" src={C} alt="blog" />
                        <div class="px-6 py-8">
                            <h4 class="mt-4 text-2xl font-semibold text-neutral-600">
                            <span class="">Entry</span>
                            </h4>
