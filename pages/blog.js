          ...
          <section class="w-full py-24 px-12 mx-auto max-w-6xl md:w-3/4 lg:w-3/4">
            <div class="grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3">
              <div class="col-span-1 md:col-span-2 lg:col-span-2 xl:col-span-3">
                <Image
                  src={NFT}
                  class="object-cover w-full h-48 mb-5 bg-center rounded"
                  alt="NFT"
                />
                <p class="mb-2 mt-1 text-xs font-semibold tracking-wider text-gray-400 uppercase">
                  Documentation
                </p>
                <h2 class="mb-2 mt-8 text-xl font-bold leading-snug text-gray-900">
                  <a href="#" class="text-purple-600">
                    Learn about NFT and our marketplace, information about
                    everything.
                  </a>
                </h2>
                <p class="mb-4 text-sm font-normal text-gray-600">
                  This application is a platform for Artists, Creators and
                  Traders of intellectual property known as Non-Fungible Tokens
                  (NFT’s). This platform is also made for enthusiasts for
                  exploring more about NFT’s for future. NFT’s are new topic in
                  the present and also the future for crypto industry.
                </p>
                ...
                <>
                  <div>
                    ...
                    <h2 class="mb-2 text-xl font-extrabold leading-snug tracking-tight text-gray-800 md:text-3xl">
                      <span className="text-gray-100 hover:text-purple-600 ">
